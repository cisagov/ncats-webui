...
export class NavbarComponent implements OnInit {
  ...
  constructor(public cyhyDataService: CyhyDataService,
  ...
  _configureNavbar(): void {
    ...
    this.navbarConfig.monitoringDropdown = this.navbarConfig.dashboard
                                            || this.navbarConfig.history
                                            || this.navbarConfig.status
					    || this.navbarConfig.hiringdashboard;

    this.navbarConfig.mapsDropdown = this.navbarConfig.hostmap
                                      || this.navbarConfig.vulnerabilitymap
                                      || this.navbarConfig.scanmap;

    this.navbarConfig.reportsDropdown = this.navbarConfig.bod
  ...
  _initializeUnderscan(): void {
    ...
    let horizontalUnderscan = this.cookies.get(CookieService.HORIZONTAL_UNDERSCAN);
